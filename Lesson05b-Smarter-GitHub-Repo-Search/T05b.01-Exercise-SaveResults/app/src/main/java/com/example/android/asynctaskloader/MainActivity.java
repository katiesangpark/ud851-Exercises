...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESULT_RAW_JASON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            String rawJsonSearchResults = savedInstanceState.getString(SEARCH_RESULT_RAW_JASON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
       ...
       outState.putString(SEARCH_RESULT_RAW_JASON, rawJsonSearchResults);
    }
}